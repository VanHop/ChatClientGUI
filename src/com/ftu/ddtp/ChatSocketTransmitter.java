...
import com.ftu.ddtp.SocketServer;
import com.ftu.ddtp.Transmitter;
...
public class ChatSocketTransmitter implements Runnable,Transmitter
{
...
//	protected Vector mvtResponse = new Vector();
	...
	//public LinkQueue<DDTP> mlqResponseVsip = new LinkQueue<DDTP>();
	...
	public SocketServer processor1 = new SocketServer(this);
	public SocketServer processor2 = new SocketServer(this);
	public SocketServer processor3 = new SocketServer(this);
	public SocketServer processor4 = new SocketServer(this);
	public SocketServer processor5 = new SocketServer(this);
	 ...
	 */
	////////////////////////////////////////////////////////////
	public ChatSocketTransmitter(Socket sck)
	{
		msckMain = sck;
	}
	////////////////////////////////////////////////////////////
